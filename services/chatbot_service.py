...
class ChatbotService:
    ...
    # ▼▼▼ [최종 수정] 키워드 분석 로직 (모든 질문 대응 + 로드/저장 구분 강화) ▼▼▼
    @staticmethod
    def get_keyword_response(query: str) -> dict:
        ...
        responses = [
            # -----------------------------------------------------------
            # 1. 시나리오/프리셋 관리 (핵심 수정 부분)
            # -----------------------------------------------------------

            # [시나리오 로드] - 빌더 내 기능 설명으로 수정
            {
                "keywords": ['시나리오', 'scenario', '로드', 'load', '불러오기', '열기'],
                "required": ['시나리오', '로드'],
                "answer": "📖 **시나리오 로드 (Load Scenario)**\n\n빌더 모드에서 **'Load Scenario'** 버튼을 클릭하면, 서버에 저장된 내 시나리오 목록을 불러올 수 있습니다.\n\n원하는 시나리오를 선택하면 작성하던 내용을 에디터로 가져와 이어서 작업할 수 있습니다.",
                "choices": ["프리셋 로드란?", "시나리오 저장 방법", "빌더 모드 이동"]
            },
            ...
            # [프리셋 vs 시나리오 차이]
            {
                ...
                "required": ['프리셋', '시나리오'], # '차이'나 '비교'가 없어도 둘 다 언급하면 이 답변이 나갈 수 있음 (점수 계산 유의)
            ...
            # [부적절한 내용 (욕설/선정성)]
            {
                "keywords": ['부적절', '욕설', '야한', '선정', '19금', '입력', '필터'],
                "required": ['부적절', '욕설', '선정', '입력'],
            ...
            {
                "keywords": ['내', '작품', '목록', '리스트', '확인', '보고', 'list'],
                "required": ['시나리오', '내'],
                "answer": "📂 **내 시나리오 목록 확인**\n\n작성 중이거나 완성된 내 작품들은 **마이페이지 > 내 시나리오** 탭에서 확인하실 수 있습니다.\n\n목록에서 시나리오를 클릭하면 상세 정보를 보거나 빌더로 이동할 수 있습니다.",
                "choices": ["비밀번호 변경", "마이페이지로 이동", "요금제 안내"]
            },
