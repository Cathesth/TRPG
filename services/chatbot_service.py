...
class ChatbotService:
    ...
    def get_keyword_response(query: str) -> dict:
        ...
        responses = [
            ...
            # [씬 배경 설정] - (수정됨: AI 이미지 생성 안내)
            {
                "keywords": ['배경', 'background', 'bg', '설정', '변경', '바꾸', '이미지', '넣기'],
                "required": ['배경', 'background'],
                "answer": "🖼️ **씬 배경 설정 방법**\n\n장면에 어울리는 배경을 **AI 이미지 생성**을 통해 설정해 보세요!\n\n1. 편집하려는 **씬 노드를 클릭**하여 에디터를 엽니다.\n2. 하단의 **'Generate Image'** 버튼을 클릭합니다.\n3. **'Scene Background'** 타입을 선택하고 분위기를 묘사하면 멋진 배경이 생성됩니다.",
            ...
            # [AI 이미지 생성 방법] - (수정 및 상세화)
            {
                ...
                "choices": ["이미지 생성 오류 해결", "씬 배경 설정", "요금제 안내"]
            },

            # [AI 이미지 생성 오류/문제] - (신규 분리)
            {
