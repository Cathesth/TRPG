...
class ChatbotService:
    ...
    def get_keyword_response(query: str) -> dict:
        ...
        responses = [
            ...
            # [전체 씬 보기 / 디버그 도구] - (요청하신 [전체씬 보기] 포함)
            {
                "keywords": ['전체', '씬', '보기', '구조', 'map', '지도', '디버그', 'debug', '버그', '시각화'],
                "required": ['전체', '디버그', 'debug', '시각화'],
                "answer": "🗺️ **전체 씬(구조) 보기**\n\n플레이 화면 우측 하단의 **벌레 아이콘(🐛)**을 클릭해 보세요.\n\n**디버그 모드(Scene Visualizer)**가 열리며, 현재 시나리오의 전체 노드 구조와 진행 상황을 한눈에 확인할 수 있습니다.",
